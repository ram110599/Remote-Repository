...
%DIF DEL new.tex   Mon Feb 19 15:55:54 2018
%DIF ADD old.tex   Mon Feb 19 15:55:50 2018
...
%DIF < \documentclass{new}
%DIF -------
\documentclass{sig-alternate} %DIF > 
...
% 1st. author
\alignauthor
\DIFdelbegin \DIFdel{Komal }\DIFdelend \DIFaddbegin \DIFadd{Mukesh Saini }\DIFaddend \\%\titlenote{Dr.~Trovato insisted his name be first.}\\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{Indian Institute Of Technology, Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{National University of Singapore}\DIFaddend \\
       \DIFdelbegin %DIFDELCMD < \email{2016csb1124@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{mksaini@comp.nus.edu.sg}
\DIFaddend % 2nd. author
\alignauthor
\DIFdelbegin \DIFdel{Prasad }\DIFdelend \DIFaddbegin \DIFadd{Raghudeep Gadde }\DIFaddend \\%\titlenote{The secretary disavows
...
\DIFdelend \DIFaddbegin \affaddr{National University of Singapore}\DIFaddend \\
       ...
       \DIFdelbegin %DIFDELCMD < \email{2016csb1041@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{elerdg@nus.edu.sg}
\DIFaddend \and
% 3rd. author
\alignauthor \DIFdelbegin \DIFdel{Vivek }\DIFdelend \DIFaddbegin \DIFadd{Shuicheng Yan }\DIFaddend \\%\titlenote{This author is the
%one who did all the really hard work.}\\
       \affaddr{Dept. of ECE}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{Indian Institute Of Technology, Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{National University of Singapore}\DIFaddend \\
     %  \affaddr{Hekla, Iceland}\\
       \DIFdelbegin %DIFDELCMD < \email{2016csb1064@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{eleyans@nus.edu.sg}
\DIFaddend %\and  % use '\and' if you need 'another row' of author names
% 4th. author
\alignauthor \DIFdelbegin \DIFdel{Ram Krishna}\DIFdelend \DIFaddbegin \DIFadd{Wei Tsang Ooi}\DIFaddend \\
       \affaddr{Dept. of Computer Science}\\
       \DIFdelbegin %DIFDELCMD < \affaddr{Indian Institute Of Technology, Ropar}%%%
\DIFdelend \DIFaddbegin \affaddr{National University Of Singapore}\DIFaddend \\
       %\affaddr{P.O. Box 5000}\\
       \DIFdelbegin %DIFDELCMD < \email{2016csb1053@iitrpr.ac.in}
%DIFDELCMD < %%%
\DIFdelend \DIFaddbegin \email{ooiwt@comp.nus.edu.sg}
\DIFaddend }
...
MoViMash framework.
\DIFdelbegin \DIFdel{I am adding a new line in every section.
...
1.14 billion in the year 2011 alone \cite{rfc1}.Furthermore, a survey of
over 2,500 respondents by Photobucket reveals that 45\% of the respondents
use mobile devices to shoot video at least once weekly during the summer of 2011, validating the significant increase in the amount of mobile video uploaded to Photobucket\textquotesingle s video sharing website (14 x in Summer 2011 compared to December 2010)\cite{rfc2}.

\DIFdelbegin \DIFdel{I am adding a new line in every section.
}\DIFdelend Proliferation of such mobile devices with video capture capability
...
\DIFdelbegin \DIFdel{I am adding a new line here.
}\DIFdelend There has been only few works on online camera selection. In
...
components.
\DIFdelbegin \DIFdel{I am adding a new line here.
}\DIFdelend \subsection{Design Principles}
...
%\begin{split}
%I^e(x,y) & = 1 if edge is detected at pixel I(x, y),
 %   & = 0 otherwise
%\end{split}
\end{tabular}
\end{equation}
...
is the number of such pixels, the quality score representing burnt pixels is calculated as follows:
\begin{equation}
    S^{bp} = \begin{cases}
    1-N^b/(0.25*N^i), \text{if } N^b/(0.25*N^i) \leq 1\\
    0, \text{otherwise}
    \end{cases}
\end{equation}
...
being researched separately \cite{rfc14}. The details of the performances and video recordings are given in the   Table 2.  Figure 6 shows selected frames for each performance.
...
final mashup.\newline
\DIFdelbegin \DIFdel{I am adding a new line. 
}\DIFdelend \DIFaddbegin 

\DIFaddend \textbf{\large Acknowledgments}\newline
...
\bibitem{rfc1}http://www.bloomberg.com/news/2011-04-07/high-resolution-cameras-will-drive-mobile-phone-shipments-above-1-billion.html.
\bibitem{rfc2}http://www.businesswire.com/news/home
/20110829005068/en/photobucket-survey-video-uploads-mobile-devices-rise. 
\bibitem{rfc3}M. Al-Hames, B. H\"{o}rnler, C. Scheuermann, and G. Rigoll. Using audio, visual, and lexical features in a multi-modal
virtual meeting director. In Proc. of Machine Learning for
Multimodal Interaction, pages 63 \textemdash 74. Springer, Bethesda,
MD, USA, May 2006.
\bibitem{rfc4}M. Campanella, H. Weda, and M. Barbieri. Edit while
...
\bibitem{rfc5}F. Crete, T. Dolmiere, P. Ladret, and M. Nicolas. The blur effect: perception and estimation with a new no-reference
perceptual blur metric. In Proc. of SPIE Human Vision and
Electronic Imaging XII, volume 6492, San Jose, CA, USA,
January 2007.
\bibitem{rfc6}R. Cutler, Y. Rui, A. Gupta, J. Cadiz, I. Tashev, L. He, A. Colburn, Z. Zhang, Z. Liu, and S. Silverberg. Distributed
meetings: A meeting capture and broadcasting system. In
Proc. of ACM International Conference on Multimedia,
pages 503\textemdash512. ACM, Juan Les Pins, France, December
2002.
\bibitem{rfc7}E. de Lima, C. Pozzer, M. d\textquotesingle Ornellas, A. Ciarlini, B. Feij\'{o}, and A. Furtado. Virtual cinematography director for interactive storytelling. In Proc. of International Conference
on Advances in Computer Enterntainment Technology, pages
263\textemdash270, Athens, Greece, October 2009.
\bibitem{rfc8}A. Engstrom, M. Esbjornsson, O. Juhlin, and M. Perry.
...
TV and Video, pages 115\textemdash124, Silicon Valley, CA, USA,
October 2008.
\bibitem{rfc9}E. Machnicki and L. Rowe. Virtual director: Automating a webcast. In Proc. of the SPIE Multimedia Computing and Networking, volume 4673, 2002.
\bibitem{rfc10}A. K. Moorthy, P. Obrador, and N. Oliver. Towards
computational models of the visual aesthetic appeal of
consumer videos. In Proc. of the 11th European conference
on Computer vision: Part V, pages 1\textemdash14, Crete, Greece,
September 2010.
\bibitem{rfc11}N. Quang Minh Khiem, G. Ravindra, A. Carlier, and W. Ooi. Supporting zoomable video streams with dynamic
region-of-interest cropping. In Proc. of the first annual ACM
SIGMM Conference on Multimedia Systems, pages 259\textemdash270.
ACM, 2010.
\bibitem{rfc12}A. Ranjan, R. Henrikson, J. Birnholtz, R. Balakrishnan, and D. Lee. Automatic camera control using unobtrusive vision
and audio tracking. In Proc. of Graphics Interface, pages
47\textemdash54. Canadian Information Processing Society, Ottawa,
Ontario, Canada, May 2010.
\bibitem{rfc13}A. Senior, A. Hampapur, Y. Tian, L. Brown, S. Pankanti, and R. Bolle. Appearance models for occlusion handling. Image
and Vision Computing, 24(11):1233\textemdash1243, 2006.
\bibitem{rfc14}P. Shrestha, M. Barbieri, and H. Weda. Synchronization of multi-camera video recordings based on audio. In Proc of
ACM International Conference on Multimedia, pages
545\textemdash548, Augsburg, Germany, September 2007.
\bibitem{rfc15}P. Shrestha, H. de With Peter, H. Weda, M. Barbieri, and E. Aarts. Automatic mashup generation from multiple-camera concert recordings. In Proc. of ACM International Conference on Multimedia, pages 541\textemdash550, Firenze, Italy, October 2010.
\bibitem{rfc16}J. Wang, C. Xu, E. Chng, H. Lu, and Q. Tian. Automatic
composition of broadcast sports video. Multimedia Systems,
14(4):179\textemdash193, 2008.
\bibitem{rfc17}Z. Wang, A. C. Bovik, H. R. Sheikh, and E. P. Simoncelli. Image quality assessment: From error visibility to structural similarity. IEEE Trans. on Image Processing, 13(4):600\textemdash612,
2004.
\bibitem{rfc18}Z. Wang, H. Sheikh, and A. Bovik. No-reference perceptual quality assessment of jpeg compressed images. In Proc. of IEEE International Conference on Image Processing, pages
477\textemdash480, Rochester, NY, USA, September 2002.
\bibitem{rfc19}T. Yang, Q. Pan, J. Li, and S. Li. Real-time multiple objects tracking with occlusion handling in dynamic scenes. In Proc. of IEEE Conference on Computer Vision and Pattern Recognition, pages 970\textemdash975, San Diego, CA, USA, June 2005.
\bibitem{rfc20}B. Yu, C. Zhang, Y. Rai, and K. Nahrstedt. A three-layer virtual director model for supporting automated multi-site distributed education. In IEEE International Conference on Multimedia and Expo, pages 637\textemdash640, Toronto, Ontario, Canada, July 2006.
\bibitem{rfc21}C. Zhang, Y. Rui, J. Crawford, and L. He. An automated
end-to-end lecture capture and broadcasting system. ACM
Tran. on Multimedia Computing, Communications, and
Applications, 4(1):6:1\textemdash6:23, 2008.
\end{thebibliography}
